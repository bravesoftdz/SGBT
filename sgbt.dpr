...
uses
  ...
  untPresentRecharge in 'untPresentRecharge.pas' {frmPresentRecharge},
  untMachineRecord in 'untMachineRecord.pas' {frmMachineRecord},
  untNewMember in 'untNewMember.pas' {frmNewMember},
  untCoinRefund in 'untCoinRefund.pas' {frmCoinRefund},
  Fileinput_machinerecordUnit in 'Fileinput_machinerecordUnit.pas' {frm_Fileinput_machinerecord},
  Frontoperate_InitCardIDUnit in 'Frontoperate_InitCardIDUnit.pas' {frm_bind_cardheadid},
  Frontoperate_incvalueUnit in 'Frontoperate_incvalueUnit.pas' {frm_Frontoperate_incvalue},
  QC_AE_LineBarscanUnit in 'QC_AE_LineBarscanUnit.pas' {frmExchangeLottry},
  untCoinInitialRecord in 'untCoinInitialRecord.pas' {frmCoinInitial},
  ...
  IC_Report_SaletotalUnit in 'IC_Report_SaletotalUnit.pas' {frmReport},
  ...
  untCoinRecharge in 'untCoinRecharge.pas' {frmCoinRecharge};
...
begin
  ...
  Application.CreateForm(TfrmPresentRecharge, frmPresentRecharge);
  Application.CreateForm(TfrmMachineRecord, frmMachineRecord);
  Application.CreateForm(TfrmNewMember, frmNewMember);
  Application.CreateForm(TfrmCoinRefund, frmCoinRefund);
  Application.CreateForm(Tfrm_Fileinput_machinerecord, frm_Fileinput_machinerecord);
  Application.CreateForm(Tfrm_bind_cardheadid, frm_bind_cardheadid);
  Application.CreateForm(Tfrm_Frontoperate_incvalue, frm_Frontoperate_incvalue);
  Application.CreateForm(TfrmExchangeLottry, frmExchangeLottry);
  Application.CreateForm(TfrmCoinInitial, frmCoinInitial);
  ...
  Application.CreateForm(TfrmCoinRecharge, frmCoinRecharge);
