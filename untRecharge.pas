...
function TfrmRecharge.generateOnlineRechargeApplyURL(): string;
var
...
function TfrmRecharge.getOnlineRechargeApplySignature(appId: string; bandId: string; restCoin: string; shopId: string; timeStamp: string): string;
var
...
function TfrmRecharge.generateOnlineRechargeAckURL(haokuTrxId: string; trxId: string): string;
var
...
function TfrmRecharge.getOnlineRechargeAckSignature(appId: string; bandId: string; haokuTrxId: string; shopId: string; timeStamp: string; trxId: string): string;
var
  strTempC, strTempD: string;
  myMD5: TIdHashMessageDigest5;
begin
...
function TfrmRecharge.generateOfflineRechargeApplyURL(): string;
var
...
function TfrmRecharge.getOfflineRechargeApplySignature(appId: string; bandId: string; coin: string; money: string; restCoin: string; shopId: string; timeStamp: string): string;
var
  strTempC, strTempD: string;
  myMD5: TIdHashMessageDigest5;
begin
...
function TfrmRecharge.generateOfflineRechargeAckURL(haokuTrxId: string; trxId: string): string;
var
  strURL, appId, bandId, shopId, timestamp, strSignature, strActiveURL, strhkscURL: string;
begin
  appId := SGBTCONFIGURE.appid;
...
function TfrmRecharge.getOfflineRechargeAckSignature(appId: string; bandId: string; haokuTrxId: string; shopId: string; timeStamp: string; trxId: string): string;
var
  strTempC, strTempD: string;
  myMD5: TIdHashMessageDigest5;
begin
...
procedure TfrmRecharge.FormShow(Sender: TObject);
begin
...
function TfrmRecharge.initRechargeRecord(): string;
var
  strSQL: string;
begin
...
procedure TfrmRecharge.commRechargeReceiveData(Sender: TObject; Buffer: Pointer;
  BufferLength: Word);
var
  i: integer;
  recStr: string;
...
procedure TfrmRecharge.checkCMDInfo();
var
  tmpStr: string;
begin
   //首先截取接收的信息
...
procedure TfrmRecharge.returnFromIncrCMD();
begin
...
procedure TfrmRecharge.returnFromReadCMD();
begin
...
procedure TfrmRecharge.showCardInformation();
begin
...
procedure TfrmRecharge.saveRechargeRecord();
var
...
procedure TfrmRecharge.initIncrOperation(strRechargeCoin: string);
var
  strValue: string;
begin
...
function TfrmRecharge.caluSendCMD(strCMD: string; strIncrValue: string): string;
var
...
procedure TfrmRecharge.generateIncrValueCMD(S: string);
begin
  orderLst.Clear();
  recDataLst.Clear();
  curOrderNo := 0;
...
procedure TfrmRecharge.prcSendDataToCard();
var
  orderStr: string;
begin
...
procedure TfrmRecharge.btnOfflineRechargeClick(Sender: TObject);
var
...
function TfrmRecharge.checkCoinLimit(strWriteValue: string): boolean;
begin
  result := false;
...
procedure TfrmRecharge.FormClose(Sender: TObject;
...
procedure TfrmRecharge.btnOnlineRechargeClick(Sender: TObject);
